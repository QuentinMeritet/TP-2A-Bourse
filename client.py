...
class Reseau:
    ...
    def __init__(self, host="193.54.21.49", port=23456):
        ...
        self.__message = {"TOP": "1", "SOLDE": "2", "OPERATIONS": "3", "ACHATS": "4 ", "VENTES": "5 ", "HISTO": "6 ",
                          "ASK": "7 ", "BID": "8 ",
    ...
    def top(self):
        ...
        self.__tempsFinPartie = time.time() + int(
            eval(self.__recevoir())['temps'])  # lance le 'chronometre' quand le serveur a lance le top
    ...
    def fin(self):
        ...
        if (
            tempsRestant > 0):  # Dans ce cas, pas besoin de faire une requête au serveur, on affiche simplement le temps restant
